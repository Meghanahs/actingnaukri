	...
	<body>
		<div class="wrapper">  
			<!--<section class="download-app" style="background-image:url(http://via.placeholder.com/1920x850);">-->
				<div class="container" id="layout" style="border: 1px solid;margin-top: 72px;width: 35%;">
				    <h3 text-align:center;>Password Reset</h3>
					<form action="http://movies.siddhrans.com/index.php/Forgotpassword/changePasswordAction" method="post">
						    <input type="hidden" name="email" class="form-control" value="<?php echo $_GET['mail'] ?>">
				<label>	New Password:</label><span style="width: 35%;"><input type="password" name="password" class="form-control"  placeholder="Password" required="" value="<?php echo set_value('password'); ?>"></span>
							<button class="btn btn-login" type="submit">Submit</button>
						</form>
					<!--/row-->
				</div>
		<!--	<button>	<a href="http://movies.siddhrans.com" class="btn call-btn"><i class="fa fa-arrow-left"></i>GO BACK</a></button>-->
		<!--	</section>-->
