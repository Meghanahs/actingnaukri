...
<html class="no-js" lang="zxx">
	...
	<body>
		<div class="wrapper">  
			...
			<div class="home-three-banner" style="background-image:url(http://via.placeholder.com/1920x850);">  
						...
						<div class="col-md-8 col-sm-10 banner-text">
							...
							<form class="bt-form">
								<div class="col-md-6 col-sm-6">
									<input type="text" class="form-control" placeholder="Skills, Designations">
								</div>
								<div class="col-md-6 col-sm-6">
