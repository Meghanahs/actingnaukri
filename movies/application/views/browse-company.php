		...
		<!-- Collect the nav links, forms, and other content for toggling -->
			...
			<section class="browse-company">
				<div class="container">
					...
					<a href="<?php echo base_url();?>company-detail.html" class="item-click">
						<article>
					...
					<div class="row">
						<ul class="pagination">
							...
							<li><a href="<?php echo base_url();?>#"><i class="fa fa-ellipsis-h"></i></a></li> 
							<li><a href="<?php echo base_url();?>#">&raquo;</a></li> 
						</ul>
					</div>
