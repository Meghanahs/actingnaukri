...
<html class="no-js" lang="zxx">
    ...
    <!-- Animate -->
    <link href="<?php echo base_url();?><?php echo base_url();?>assets/plugins/animate/animate.css" rel="stylesheet">
						...
						<div class="detail pannel-footer">
							<div class="col-md-12 col-sm-12">
								<div class="detail-pannel-footer-btn pull-right">
									<a href="<?php echo base_url();?>#" class="footer-btn choose-cover">Choose Cover Image</a>
								</div>
							</div>
						</div>
					</div>
