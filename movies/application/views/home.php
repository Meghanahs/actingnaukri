...
<html class="no-js" lang="zxx">
	...
	<body>
		<div class="wrapper">  
			...
			<nav class="navbar navbar-default navbar-fixed navbar-transparent white bootsnav">
				...
				<!--	<div class="collapse navbar-collapse" id="navbar-menu">
						...
						<ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
							...
							<li><a href="javascript:void(0)"  data-toggle="modal" data-target="#usersignup" class="signin">Sign In Now</a></li>
							<li class="left-br"><a href="javascript:void(0)"  data-toggle="modal" data-target="#recruitersignup" class="signin"><i class="fa fa-group"></i>Recruiter Login</a></li>
						</ul>
					</div>
				</div>   
			</nav>
			...
			<!-- Sign Up Window Code -->
			<div class="modal fade" id="usersignup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2" aria-hidden="true">
							...
							<div class="tab-content" id="myModalLabel2">
								<div role="tabpanel" class="tab-pane fade in active" id="login">
									...
									<div class="subscribe wow fadeInUp">
										<form class="form-inline" method="post" action="http://movies.siddhrans.com/index.php/User/login">
											<div class="col-sm-12">
												<div class="form-group">
													...
													<div class="center">
													<button type="submit" id="login1-btn" class="submit-btn">Login</button></br>
													<span><a href="<?php echo base_url(); ?>index.php/forgotpassword/index">Forgot Password</a></span>
													</div>
												</div>
											</div>
										</form>
			...
			<!-- Sign Up Window Code for recruiter-->
			<div class="modal fade" id="recruitersignup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-body">
							<div class="tab" role="tabpanel">
							<!-- Nav tabs -->
							<ul class="nav nav-tabs" role="tablist">
								<li role="presentation" class="active"><a href="#login1" role="tab" data-toggle="tab">Sign In</a></li>
								<li role="presentation"><a href="#register1" role="tab" data-toggle="tab">Sign Up</a></li>
							...
							<div class="tab-content" id="myModalLabel2">
								<div role="tabpanel" class="tab-pane fade in active" id="login1">
									<img src="assets/img/logo.png" class="img-responsive" alt="" />
									<div class="subscribe wow fadeInUp">
										<form class="form-inline" method="post" action="http://movies.siddhrans.com/index.php/User/recruiterlogin">
											<div class="col-sm-12">
												<div class="form-group">
								...
								<div role="tabpanel" class="tab-pane fade" id="register1">
								<img src="<?php echo base_url(); ?>assets/img/logo.png" class="img-responsive" alt="" />
								
						
									<form class="form-inline" method="post" action="http://movies.siddhrans.com/index.php/User/recruiterRegistration">
											<div class="col-sm-12">
												<div class="form-group">
												<label>Name :</label><input type="text"  name="name" class="form-control" placeholder="Your name" >
												<label>Email :</label><input type="email"  name="email" class="form-control" placeholder="Your Email">
