		...
		<div class="wrapper">  
						...
						<ul class="nav navbar-nav navbar-left" data-in="fadeInDown" data-out="fadeOutUp">
											...
											<div class="col-menu col-md-3">
												...
												<div class="content">
													<ul class="menu-col">
                                                        ...
                                                        <li><a href="<?php echo base_url(); ?>index.php/load/job15">Candidate Profile</a></li>															
													</ul>
												</div>
											</div><!-- end col-3 -->
											<div class="col-menu col-md-3">
							...
							<li><a href="blog.html">Blog</a></li>
								...
								<ul class="dropdown-menu dropdown-user">
									...
									<li><a href="<?php echo base_url(); ?>index.php/User/user"><i class="fa fa-user fa-fw"></i>Edit Profile</a></li>
				...
				<div class="container white-shadow">
					...
					<div class="row">
						...
						<div class="detail-pic">
							...
							<a href="<?php echo base_url();?>#" class="detail-edit" title="edit" ><i class="fa fa-pencil"></i></a>
						</div>
						...
						<div class="detail pannel-footer">
							...
							<div class="col-md-7 col-sm-7">
								<div class="detail-pannel-footer-btn pull-right">
									<a href="<?php echo base_url();?>#" class="footer-btn grn-btn" title="">Quick Apply</a>
									<a href="<?php echo base_url();?>#" class="footer-btn blu-btn" title="">Save Draft</a>
								</div>
							</div>
						</div>
					</div>
			...
			<footer class="footer">
				<div class="row lg-menu">
					<div class="container">
						<div class="col-md-4 col-sm-4">
							<img src="<?php echo base_url();?>assets/img/footer-logo.png" class="img-responsive" alt="" /> 
						</div>
					...
					<div class="modal-content">
						<div class="modal-body">
							...
							<ul class="nav nav-tabs" role="tablist">
								<li role="presentation" class="active"><a href="<?php echo base_url();?>#login" role="tab" data-toggle="tab">Sign In</a></li>
								<li role="presentation"><a href="<?php echo base_url();?>#register" role="tab" data-toggle="tab">Sign Up</a></li>
							</ul>
							<!-- Tab panes -->
			...
			<!-- Owl carousel Js -->
			<script type="text/javascript" src="<?php echo base_url();?>assets/plugins/owl-carousel/js/owl.carousel.min.js"></script>
