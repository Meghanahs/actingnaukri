...
<html class="no-js" lang="zxx">
	...
	<link rel="stylesheet" href="<?php echo base_url(); ?><?php echo base_url(); ?>assets/plugins/bootstrap/css/bootstrap-theme.min.css">
			...
			<section class="lost-ps-screen-sec">
				<div class="container">
					<div class="lost-ps-screen">
						<a href="index.html"><img src="<?php echo base_url(); ?>assets/img/logo.png" class="img-responsive" alt=""></a>
						<form action="http://movies.siddhrans.com/index.php/Forgotpassword/password" method="post">
