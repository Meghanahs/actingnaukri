...
<html class="no-js" lang="zxx">
	...
	<body>
		<div class="wrapper">  
			...
			<div class="home-plane-banner" style="background-image:url(http://via.placeholder.com/1920x850);">  
				<!-- Wrapper for carousel items -->
				<div class="container">
					<div class="simple-banner-caption">
							<div class="col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2 banner-text">
								<h1>Let's Start Your Job<br> With <span>Job Stock</span> Team</h1>
								...
								<a href="#" class="btn btn-banner">Get Started</a>
							</div>
					</div>
				</div>
			</div>
