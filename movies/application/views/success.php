	...
	<body>
		<div class="wrapper">  
			<section class="download-app" style="background-image:url(http://via.placeholder.com/1920x850);">
				<div class="container">
					<h3 style="text-align:center;color:black;opacity: 0.5;">You have registered and the activation mail is sent to your email. Click the activation link to activate you account.</h3>
		...
		<!--	<button>	<a href="http://movies.siddhrans.com" class="btn call-btn"><i class="fa fa-arrow-left"></i>GO BACK</a></button>-->
			...
			<button class="btn info" style="margin-left: 40%;"><a href="http://movies.siddhrans.com" class="btn call-btn"><i class="fa fa-arrow-left"></i>GO BACK</a></button>
